...
Now that you understand the layout, learn how to [interact with candidates](/modules/ats-platform/candidate-list-view/interacting) within the Pipeline View.