...
After updating candidate stages, you may want to [view their resumes](/modules/ats-platform/candidate-list-view/viewing-resumes) to prepare for the next steps in the hiring process.