...
If you encounter any issues while navigating through candidates or using any other features of the ATS, refer to our [troubleshooting guide](/modules/ats-platform/candidate-list-view/troubleshooting) for solutions to common problems.