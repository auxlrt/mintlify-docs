...
After updating candidate details, you might want to use our [searching and filtering](/modules/ats-platform/candidate-list-view/searching-filtering) features to organize your candidates based on the updated information.