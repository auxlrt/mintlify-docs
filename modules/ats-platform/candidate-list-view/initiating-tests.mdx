...
After initiating tests, you may need to [edit candidate details](/modules/ats-platform/candidate-list-view/editing-details) to update their information based on test results or other new information.