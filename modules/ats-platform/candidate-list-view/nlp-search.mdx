...
After finding relevant candidates using NLP search, you may need to [navigate through multiple pages](/candidate-pipeline-view/navigation) of results to review all potential matches.