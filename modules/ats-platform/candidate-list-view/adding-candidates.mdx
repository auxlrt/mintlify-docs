...
After adding new candidates, you might want to use our [NLP search feature](/modules/ats-platform/candidate-list-view/nlp-search) to quickly find the most relevant candidates for your open positions.